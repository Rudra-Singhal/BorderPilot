...
class BankPacket(Base):
    ...
    gross_obligations_usd: Mapped[float] = mapped_column(Numeric(14, 2), nullable=False)
    total_matched_usd: Mapped[float] = mapped_column(Numeric(14, 2), nullable=False)
    net_settlement_usd: Mapped[float] = mapped_column(Numeric(14, 2), nullable=False)
    fx_friction_savings_usd: Mapped[float] = mapped_column(Numeric(14, 2), nullable=False)
